        ...
        <div className="absolute inset-0 flex items-end bg-gradient-to-t from-black/60 to-transparent">
          <div className="flex flex-col py-4 sm:py-6 md:py-8 gap-y-2 sm:gap-y-3 md:gap-y-4 px-4 sm:px-6 md:px-20 w-full">
            <div className="flex w-full md:w-[55%]">
              <span className="bg-[#4545a3] rounded-full px-3 py-1 text-xs sm:text-sm text-white font-latoRegular">
                {blogPosts[0].tag}
              </span>
            </div>
            ...
            <span className="text-emerald-400 group-hover:text-emerald-200 transition-colors duration-300 text-md font-latoRegular">
              Read More
            </span>
          </div>
        </div>
